...
```
    ...
    ## Obtaining Data: 1 out of 2 iterations (50% complete)Obtaining Data: 2 out of 2
...
```
    ...
    ## Obtaining Data: 1 out of 6 iterations (16.67% complete)Obtaining Data: 2 out of
    ## 6 iterations (33.33% complete)Obtaining Data: 3 out of 6 iterations (50%
    ## complete)Obtaining Data: 4 out of 6 iterations (66.67% complete)Obtaining Data:
    ## 5 out of 6 iterations (83.33% complete)Obtaining Data: 6 out of 6 iterations
    ## (100% complete)
...
Now we can answer our original question: How much did FEMA award for
